...
class Config(object):
	...
	UPDATES_CHANNEL = os.environ.get("-1003739193452", None)
	LOG_CHANNEL = int(os.environ.get("-1003999542749"))
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "-1003950093536").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-1003918351867").split()))
